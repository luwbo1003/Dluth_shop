<div>
    <div class="fixed-top prevent-select bg-primary" id="sidebar" style="min-height: 100vh; width: 340px;">
        ...
        <div>
            <ul class="p-0 m-0">
                ...
                <a class="d-block text-white text-decoration-none" href="<?= URLROOT ?>/Manage/order" style="padding: 18px">
                    <span class="material-symbols-outlined align-middle ms-2 me-2">
                        order_approve
                    </span>
                    <span class="align-middle sidebar-text">
